    ...
    <div class="page-content-wrapper">
        ...
        <div class="product-description pb-3">
            <div class="post-content bg-white py-3 mb-3">
                <div class="container">
                    <h6>Wedding Reception Services</h6>
                    <p>
                        Wedding Eventwala Reception Services is known for providing exceptional reception solutions for
                        couples in Patna.
                        We offer the very best facilities in Patna for wedding reception, ensuring that every detail is
                        perfect.
