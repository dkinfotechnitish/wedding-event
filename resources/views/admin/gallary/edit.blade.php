        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="mb-12">Edit Gallery Image</h4>
                        ...
                        <div class="card-body d-flex flex-wrap">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" id="position_img" name="position_img"
                                    ...
                                    value="{{ old('position_img', $gallery->position_img) }}" min="0">
                                @error('position_img')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3 col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_hidden" name="is_hidden"
                                        value="1" {{ old('is_hidden', $gallery->is_hidden) ? 'checked' : '' }}>
                            ...
                            <div class="mx-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i> Update Image
                                </button>
