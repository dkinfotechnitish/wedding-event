    ...
    <div class="page-content-wrapper">
        ...
        <div class="product-description pb-3">
            <div class="post-content bg-white py-3 mb-3">
                <div class="container">
                    <h6>Wedding Catering Services</h6>
                    <p>
                        Wedding Eventwala Catering Services is known for providing exceptional catering solutions for
                        weddings in Patna.
                        We offer the very best facilities in Patna for wedding catering, ensuring that every detail is
                        perfect.
